const data = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        title: "tools",
        array: ["git", "github", "vs code", "figma", "photoshop"]
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        position: "Специалист по работе с образовательными учреждениями",
        period: "07.2014 – 01.2017",
        company: "АО «Концерн «Моринсис-Агат», г. Москва",
        title: "Задачи/достижения",
        text: [
          "организация взаимовыгодного сотрудничества с учебными учреждениями СПО и ВПО для подготовки кандидатов технических специальностей в рамках обучения по целевой программе",
          "организовала и заключила 10 договоров и соглашений о сотрудничестве с образовательными учреждениями (2014\u00A0г. – 1\u00A0договор, 2017\u00A0г. – 11\u00A0договоров)",
          "увеличила количество абитуриентов, поступающих по целевой программе (2014\u00A0г. – 11\u00A0человек, 2017\u00A0г. – 43\u00A0человека)",
          "расширила круг проводимых профориентационных мероприятий (2014\u00A0г. – 2\u00A0мероприятия в год, 2017\u00A0г. – в среднем до 40 мероприятий в год)"
        ]
      }
    ]
  },
